...
namespace frmManageProducts
{
    public sealed class ManageCategories
    {
        ...
        public void DeleteCategory(Category category)
        {
            ...
            {
                using MyStockDBContext stock = new MyStockDBContext();
                //var cat = stock.Categories.SingleOrDefault(c => c.CategoryID == category.CategoryID);
                //stock.Categories.Remove(cat);
                //stock.Entry<Category>(category).State = Microsoft.EntityFrameworkCore.EntityState.Deleted;
